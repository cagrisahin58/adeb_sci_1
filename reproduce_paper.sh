...
# --- 2. Tablo 1: tam-test clean/FGSM/PGD-10 (SEED'LI — kanonik) ---------------
# NOT: click multiple flag'leri tekrarlanmali (-a fgsm -a pgd); bosluklu liste
# parse edilmez. --seed 42: PGD random-start dahil tam determinizm (C24).
...
# --- 3. Sekil 2: epsilon taramasi (SEED'LI — kanonik) -------------------------
python -m cli.main evaluate robustness -m "$R3NET" -t resnet18 \
...
# --- 10b. C-maddeleri (2026-07-10 paneli): clean-kontrol deneyleri ------------
#   C21 clean-alignment, C20 ResNet feature degradation, C22 MI-FGSM transfer
python experiments/run_c_addenda.py
...
#   (C24, 2-3. adimlara --seed 42 olarak islenmistir)
