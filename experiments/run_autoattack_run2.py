#!/usr/bin/env python3
"""AutoAttack evaluation for run2 models."""
...
def main():
    ...
    output_dir = Path("results/autoattack_run2_20260111")
    ...
    # Run2 model configs
    models_config = [
        ("ResNet18_AT_run2", "resnet18", "models/resnet18/adv/at_run2/resnet18/adv/adversarial_training/best.pth"),
        ("ViT_Tiny_AT_run2", "vit_tiny", "models/vit_tiny/adv/at_run2/vit_tiny/adv/adversarial_training/best.pth"),
    ]
    ...
    df.to_csv(output_dir / "autoattack_run2_results.csv", index=False)
    ...
    with open(output_dir / "autoattack_run2_summary.json", 'w') as f:
