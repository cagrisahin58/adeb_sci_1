...
ax.annotate("min 0.955 (Blok 8)\nsonra hafif toparlanma", xy=(xv[imin], vit_cos[imin]),
            xytext=(0.45, 0.975), fontsize=8,
            arrowprops=dict(arrowstyle="->", lw=0.8))
ax.annotate("monoton düşüş\n0.913'e", xy=(xr[-1], res_cos[-1]), xytext=(0.62, 0.935),
            fontsize=8, arrowprops=dict(arrowstyle="->", lw=0.8))
ax.set_xlabel("Göreli derinlik (blok / toplam blok)")
ax.set_ylabel("Temiz–çekişmeli kosinüs benzerliği")
